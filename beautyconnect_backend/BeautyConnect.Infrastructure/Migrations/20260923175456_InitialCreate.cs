        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatingAverage = table.Column<double>(type: "double", nullable: false),
                    TotalReviews = table.Column<int>(type: "int", nullable: false),
                    VerificationStatus = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AvatarUrl = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ServiceCategoriesJson = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PortfolioImagesJson = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_ProfessionalProfiles_ProfessionalProfileId",
                        column: x => x.ProfessionalProfileId,
                        principalTable: "ProfessionalProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_ProfessionalProfiles_ProfessionalProfileId",
                        column: x => x.ProfessionalProfileId,
                        principalTable: "ProfessionalProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Availabilities_ProfessionalProfileId_DayOfWeek",
                table: "Availabilities",
                columns: new[] { "ProfessionalProfileId", "DayOfWeek" });

            migrationBuilder.CreateIndex(
                name: "IX_Availabilities_ProfessionalProfileId_SpecificDate",
                table: "Availabilities",
                columns: new[] { "ProfessionalProfileId", "SpecificDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_ProfessionalProfileId_ScheduledDateTime_Status",
                table: "Bookings",
                columns: new[] { "ProfessionalProfileId", "ScheduledDateTime", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfessionalProfiles_City",
                table: "ProfessionalProfiles",
                column: "City");

            migrationBuilder.CreateIndex(
                name: "IX_ProfessionalProfiles_RatingAverage",
                table: "ProfessionalProfiles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfessionalProfiles_VerificationStatus",
                table: "ProfessionalProfiles",
                column: "VerificationStatus");

            migrationBuilder.CreateIndex(
                name: "IX_ProfessionalProfiles_VerificationStatus_RatingAverage",
                table: "ProfessionalProfiles",
                columns: new[] { "VerificationStatus", "RatingAverage" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Services_ProfessionalProfileId",
                table: "Services",
                column: "ProfessionalProfileId");
